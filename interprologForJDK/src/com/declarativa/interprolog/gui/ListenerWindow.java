...
public abstract class ListenerWindow extends JFrame implements WindowListener{  
    ...
    // This makes Alt-Key shortcut rather than Ctrl-Key shortcut
    public static JMenuItem addItemToMenuALT(JMenu menu, String item, int accelerator, ActionListener handler) {
        JMenuItem menuItem = new JMenuItem(item,accelerator);
