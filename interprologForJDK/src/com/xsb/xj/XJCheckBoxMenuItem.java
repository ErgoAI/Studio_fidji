...
public class XJCheckBoxMenuItem extends JCheckBoxMenuItem implements XJComponent, XJComponentTree, XJMenuItemComponent {
	GUITerm gt;
	PrologEngine engine;
        static final String ICON = "icon";
        static final String DISABLED = "disabled";

	public XJCheckBoxMenuItem(PrologEngine engine, GUITerm gt){
                super();
		this.gt=gt;
		this.engine=engine;
